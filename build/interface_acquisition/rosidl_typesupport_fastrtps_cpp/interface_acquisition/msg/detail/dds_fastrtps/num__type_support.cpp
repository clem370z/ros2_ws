...
#include "interface_acquisition/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const interface_acquisition::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<interface_acquisition::msg::Num *>(
    untyped_ros_message);
...
{
  return &interface_acquisition::msg::typesupport_fastrtps_cpp::_Num__handle;
}
